...
- (id)init
{
    ...
    if (self) {
        ...
        self.spinnerImage = SV_BUNDLE_IMAGE(@"spinner");
...
-(void)startAnimating
{
    if(![self isAnimating])
    {
        ...
        self.indefiniteTimer = [NSTimer scheduledTimerWithTimeInterval:0.025 target:self selector:@selector(rotate) userInfo:nil repeats:YES];
